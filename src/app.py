...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team play, drills, and local games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "mia@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Develop swimming techniques and compete in friendly meets",
    ...
    "Robotics Club": {
        ...
        "max_participants": 18,
        "participants": ["sophia@mergington.edu", "mateo@mergington.edu"]
    }
}
